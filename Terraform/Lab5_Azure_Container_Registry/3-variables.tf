...
variable "resourceGroupName" {
  type    = string
  default = "RG-AKSCluster-JCT"
}

#  Azure Container Registry name
variable "acrName" {
  type    = string
  default = "acrstan2022jct"   # IMPORTANT : changer ce nom et mettre un nom unique (cf. https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/ready/azure-best-practices/resource-naming#example-names-storage)
}
